...
const CONNECTORS = [
  {
    ...
    icon: "https://api.iconify.design/logos/google-workspace.svg",
    color: "#4285F4",
  },
  {
    name: "Notion",
  ...
  {
    name: "GitHub",
    icon: "https://api.iconify.design/mdi/github.svg?color=%23141413",
    color: "#141413",
  },
  {
    name: "Jira",
...
export const ConnectorsScene: React.FC = () => {
  ...
  const hubOpacity = interpolate(frame, [15, 30], [0, 1], {
    extrapolateRight: "clamp",
  });
  ...
  return (
    ...
    >
      ...
      {/* Right: Connector hub visualization */}
      <div
        style={{
          flex: 1,
          display: "flex",
      ...
      >
        ...
        >
          <span style={{ fontSize: 32, color: "white", fontWeight: 800 }}>C</span>
        </div>

        {/* Connector nodes arranged in a circle */}
          ...
          return (
            <React.Fragment key={i}>
              ...
              >
                ...
                >
                  <Img src={connector.icon} style={{ width: 28, height: 28 }} />
                </div>
                <span
                  style={{
                    fontSize: 11,
